  ...
  <div class="relative min-h-screen overflow-hidden bg-zinc-50 font-sans dark:bg-[#0a0a12] dark:text-white">
    ...
    <div class="relative z-10 mx-auto flex min-h-screen max-w-2xl flex-col items-center justify-center px-6 text-center">
      ...
      <div class="mt-10 flex items-center gap-4">
        <NuxtLink
          :to="localePath('/')"
          class="inline-flex items-center gap-2 rounded-full bg-teal-500 px-6 py-3 text-sm font-semibold text-zinc-950 transition-all duration-300 hover:bg-teal-400 hover:shadow-lg hover:shadow-teal-500/25 active:scale-95"
        >
